...
print(f"My name is {classinfo['all'][5]['name']} and my spirit animal is {classinfo['all'][5]['skill level']}.")

print(f"My name is ______ and my skills are _______.")

print(f"My name is ______ and my super power is _______.")
